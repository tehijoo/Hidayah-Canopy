...
export const metadata = {
  title: 'Jasa Pemasangan Penangkal Petir – Hidayah Canopy',
  description: 'Layanan jasa instalasi penangkal petir profesional dengan sistem grounding berstandar keamanan tinggi untuk melindungi properti Anda dari sambaran petir.',
};
    ...
    <main className="min-h-screen bg-gray-50 pb-20">
      ...
      <section className="bg-[#006295] py-20 text-center text-white px-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-lg font-medium opacity-90 italic">Jasa Instalasi & Sistem Grounding Aman</p>
        </div>
      </section>
      ...
      <section className="container mx-auto max-w-5xl px-6 mt-16">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100 text-gray-700 leading-relaxed text-justify space-y-6 relative">
          ...
          <h2 className="text-3xl font-black text-[#006295] mb-6 leading-tight">
            Perlindungan <span className="text-[#f59e0b]">Maksimal</span> untuk Properti Anda
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mt-8">
            ...
            <div className="lg:col-span-8 space-y-5 order-2 lg:order-1">
              <p className="text-lg font-medium text-gray-800">
                Indonesia berada di wilayah tropis dengan curah hujan dan intensitas badai petir yang sangat tinggi. Melindungi bangunan dan penghuninya dari bahaya sambaran petir adalah sebuah investasi keamanan yang sangat vital.
              </p>
              
              <div className="h-px bg-gray-200 w-full my-6"></div>

              <p>
                <strong className="text-[#006295]">Hidayah Canopy</strong> menghadirkan jasa instalasi penangkal petir terpadu dengan standar keamanan operasional yang tinggi. Kami melayani pemasangan untuk berbagai skala bangunan, mulai dari rumah tinggal, ruko, gedung komersial, hingga area pabrik industri.
              </p>
              
              <p>
                Sistem yang kami pasang tidak hanya berfokus pada penangkap petir di atas atap (sistem konvensional maupun elektrostatis), tetapi juga sangat mengutamakan kualitas <strong>Sistem Grounding (Pembumian)</strong>. Kami memastikan nilai tahanan tanah (resistensi) berada pada batas aman (di bawah 5 Ohm) sehingga arus petir dapat langsung dinetralkan ke dalam bumi.
              </p>

              {/* Info Box untuk menekankan bahaya dan solusi */}
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 mt-4">
                <h3 className="font-bold text-[#006295] mb-3">Mengapa Sistem Ini Sangat Penting?</h3>
                <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-600">
                  <li><strong>Mencegah Kerusakan:</strong> Menghindari retak struktur fisik bangunan akibat hantaman langsung.</li>
                  <li><strong>Melindungi Elektronik:</strong> Meminimalisir risiko korsleting perangkat elektronik (TV, Kulkas, AC) dari <em>power surge</em>.</li>
                  <li><strong>Mencegah Kebakaran:</strong> Menghilangkan potensi percikan api pemicu kebakaran.</li>
                  <li><strong>Ketenangan Batin:</strong> Keluarga dan karyawan merasa aman meskipun terjadi badai petir lebat.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 order-1 lg:order-2 w-full">
              <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border border-gray-100 relative group">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-sm border border-white">
                  <p className="text-xs font-bold text-[#006295] text-center tracking-wide uppercase">Instalasi Keamanan</p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 p-8 bg-gray-50 rounded-2xl border-l-4 border-[#006295] flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <h4 className="text-[#006295] font-bold text-xl">Lindungi Bangunan Anda Sekarang!</h4>
